...
class App extends React.Component {
  ...
  handleColorMode() {
    const changeColor = this.setState({darkMode: !this.state.darkMode}); 
    return changeColor;
  };
  ...
  render() {
    ...
    <div className={`${darkMode ? "dark-mode" : ""} app`}>
      <div className="level">
        ...
        <button className="app__dark-mode-btn icon level-right" onClick={this.handleColorMode}>
          <FontAwesomeIcon icon={darkMode ? faSun : faMoon} color={darkMode ? '#FFA500' : 'black'}/>
        </button>
